...
class AccountCommonReport(models.TransientModel):
    ...
    with_watching = fields.Boolean(string='المتابعة')
    ...
    def _build_contexts(self, data):
        ...
        result['with_watching'] = data['form']['with_watching'] or False
    ...
    def check_report(self):
        ...
        data['form'] = self.read(
            ['date_from', 'with_total','with_watching','with_posted','with_zero_balance','with_old_balance', 'tag_ids', 'date_to', 'journal_ids', 'target_move',
             'company_id'])[0]
